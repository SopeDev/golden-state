				...
				<div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
					...
					<div className="space-y-4">
						...
						<ul className="space-y-2">
							...
							<li>
								<Link href="/projects" className="text-primary-foreground/80 transition-colors hover:text-primary-foreground">
									{t('actualProjects')}
								</Link>
							</li>
							<li>
								<Link href="/fliphouses" className="text-primary-foreground/80 transition-colors hover:text-primary-foreground">
									{t('fliphouses')}
								</Link>
							</li>
							<li>
								<Link href="/buytorent" className="text-primary-foreground/80 transition-colors hover:text-primary-foreground">
									{t('buyToRent')}
								</Link>
							</li>
							<li>
								<Link href="/buytobuild" className="text-primary-foreground/80 transition-colors hover:text-primary-foreground">
									{t('buyToBuild')}
								</Link>
							</li>
						</ul>
					...
					<div className="space-y-4">
						...
						<ul className="space-y-2">
							<li>
								<Link href="/mexicotous" className="text-primary-foreground/80 transition-colors hover:text-primary-foreground">
									{t('mexicoToUs')}
								</Link>
							</li>
							<li>
